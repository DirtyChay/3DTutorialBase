...
public class EnemySpawner : MonoBehaviour {
    ...
    [SerializeField] [Tooltip("The bounds of the spawner.")]
    private Vector3 m_Bounds;

    [SerializeField] [Tooltip("A list of all enemies that can be spawned and their information.")]
    ...
    private IEnumerator Spawn(int enemyInd) {
        ...
        int i = 0;
        bool alwaysSpawn = info.NumberToSpawn == 0;

        while (alwaysSpawn || i < info.TimeToNextSpawn) {
