...
public class PlayerFollow : MonoBehaviour {
    ...
    [SerializeField] [Tooltip("The player to follow.")]
    private Transform m_PlayerTransform;

    [SerializeField] [Tooltip("The offset from the player's origin to the camera.")]
    private Vector3 m_Offset;

    [SerializeField] [Tooltip("How quickly the player can rotate the camera to the left and the right.")]
